...
- [ ] **Phase 1: Live Price Terminal** - Stand up the FastAPI app, mount the existing SSE stream, and serve a dark terminal UI where 10 default tickers stream live
- [ ] **Phase 2: Persistent Watchlist** - SQLite with lazy init and seed data, plus a watchlist the user can add to, remove from, and reload
...
|-------|----------------|--------|-----------|
| 1. Live Price Terminal | 1/5 | In Progress|  |
