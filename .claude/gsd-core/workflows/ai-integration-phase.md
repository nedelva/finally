...
<required_reading>
@/Users/valeriu/AICourses/finally/.claude/gsd-core/references/ai-frameworks.md
@/Users/valeriu/AICourses/finally/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/valeriu/AICourses/finally/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/valeriu/AICourses/finally/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/valeriu/AICourses/finally/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/valeriu/AICourses/finally/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/valeriu/AICourses/finally/.claude/agents/gsd-eval-planner.md for instructions.
