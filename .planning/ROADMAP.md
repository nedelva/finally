...
- [ ] **Phase 3: Trading & Portfolio** - Instant-fill market orders against live prices, with positions table, heatmap, P&L chart, and live cash
...
- [ ] 03-01-PLAN.md — TRACER: trade engine (`execute_trade` + `GET /api/portfolio` + `POST /api/portfolio/trade`) and the trade bar, buy and sell end to end

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 03-02-PLAN.md — Header cash balance and live total portfolio value, plus `useLiveTotalValue` and the D-03 fallback under test
...
- [ ] 03-04-PLAN.md — 30-second snapshot writer, `GET /api/portfolio/history`, and the P&L chart
...
| 3. Trading & Portfolio | 0/4 | Planned | - |
