...
```markdown
Read /Users/valeriu/AICourses/finally/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/valeriu/AICourses/finally/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/valeriu/AICourses/finally/.claude/agents/gsd-ui-checker.md for instructions.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/valeriu/AICourses/finally/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/valeriu/AICourses/finally/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/valeriu/AICourses/finally/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
