...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/valeriu/AICourses/finally/.claude/.gsd-surface.json`
(sibling to `/Users/valeriu/AICourses/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/valeriu/AICourses/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/valeriu/AICourses/finally/.claude/skills`).
...
`/Users/valeriu/AICourses/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/valeriu/AICourses/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/valeriu/AICourses/finally/.claude/.gsd-surface.json`
Install profile marker: `/Users/valeriu/AICourses/finally/.claude/.gsd-profile`
Skill dirs: `/Users/valeriu/AICourses/finally/.claude/skills/gsd-*/`
Engine module: `/Users/valeriu/AICourses/finally/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/valeriu/AICourses/finally/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
