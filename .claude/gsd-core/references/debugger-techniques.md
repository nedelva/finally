...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/valeriu/AICourses/finally/.claude
                  → checks /Users/valeriu/AICourses/finally/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/valeriu/AICourses/finally/.claude/gsd-core
                  → writes to /Users/valeriu/AICourses/finally/.claude/gsd-core/hooks/
