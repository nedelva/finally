...
Read and follow `/Users/valeriu/AICourses/finally/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
