...
<!-- For checkpoint task examples and patterns, see @/Users/valeriu/AICourses/finally/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/valeriu/AICourses/finally/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/valeriu/AICourses/finally/.claude/gsd-core/templates/user-setup.md` for full schema and examples
