...
**Verification depth scales with `asvs_level`** (full definitions: @/Users/valeriu/AICourses/finally/.claude/gsd-core/references/security-asvs-levels.md):
