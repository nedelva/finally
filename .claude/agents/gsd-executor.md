...
2. If Context7 MCP is not available (custom subagents cannot see project-scoped
   `.mcp.json` servers — they only inherit user-scoped `/Users/valeriu/AICourses/finally/.claude/mcp.json`, so a
...
@/Users/valeriu/AICourses/finally/.claude/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Users/valeriu/AICourses/finally/.claude/gsd-core/references/ios-scaffold.md
...
@/Users/valeriu/AICourses/finally/.claude/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/Users/valeriu/AICourses/finally/.claude/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes `TDD_MODE=true` (#4011 — MVP not required):** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `/Users/valeriu/AICourses/finally/.claude/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/Users/valeriu/AICourses/finally/.claude/gsd-core/templates/summary.md
