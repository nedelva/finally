...
```
Agent(
  prompt="Read /Users/valeriu/AICourses/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/valeriu/AICourses/finally/.claude/gsd-core/templates/SECURITY.md`
