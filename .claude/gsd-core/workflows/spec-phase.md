...
ones). Reference: @/Users/valeriu/AICourses/finally/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/valeriu/AICourses/finally/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/valeriu/AICourses/finally/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/valeriu/AICourses/finally/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/valeriu/AICourses/finally/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/valeriu/AICourses/finally/.claude/gsd-core/templates/spec.md.
