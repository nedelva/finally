...
| Destructive/Error | `#dc2626` (`--color-down`) | Remove-ticker button/glyph and its 24x24px hit-area background/border, validation error text and input error border |
